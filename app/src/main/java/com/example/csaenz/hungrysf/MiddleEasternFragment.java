...
public class MiddleEasternFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        restaurantsList.add(0, new Restaurant(
                getString(R.string.m_eastern_rest_one_name),
                getString(R.string.m_eastern_rest_one_location),
                R.drawable.m_eastern_rest_one_image));
        restaurantsList.add(1, new Restaurant(
                getString(R.string.m_eastern_rest_two_name),
                getString(R.string.m_eastern_rest_two_location),
                R.drawable.m_eastern_rest_two_image));
        restaurantsList.add(2, new Restaurant(
                getString(R.string.m_eastern_rest_three_name),
                getString(R.string.m_eastern_rest_three_location),
                R.drawable.m_eastern_rest_three_image));
        restaurantsList.add(3, new Restaurant(
                getString(R.string.m_eastern_rest_four_name),
                getString(R.string.m_eastern_rest_four_location),
                R.drawable.m_eastern_rest_four_image));
